---
title: "Challenge: Canada's Most Wanted"
author: Leeya Nagpal
date: "2025-07-09"
format: html
toc: true
...
This challenge was made by Eniola Olu-Ayorinde and Sarfaroz Yunusov as part of the Living Data Project working group.
...
This script shows the species that have been logged from the original most wanted list 
...
oldList <- read.csv("C:/Users/dogpa/SpeciesList/relevantSpecies/full_list_canadas_most_wanted.csv", sep = ";")
...
found <- data.frame(subset(oldList$Scientific_Name, oldList$Scientific_Name %in% newSpecies$scientific_name))
